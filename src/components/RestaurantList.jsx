...
<div class="m-4 max-w-sm  border border-gray-200 rounded-2xl shadow dark:bg-gray-800 dark:border-gray-700">
    <a href="#">
    <img className="w-full rounded-t-2xl h-64 object-cover" src={picture} alt={name} />
    </a>
